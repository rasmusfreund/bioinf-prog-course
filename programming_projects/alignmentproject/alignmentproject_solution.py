...
if __name__ == "__main__":
    ...
    dp = empty_matrix(len(a)+1, len(b)+1)
    print(dp)
    print_dp_matrix(a, b, dp)

    dp = prepare_matrix(len(a)+1, len(b)+1, gap_score)
    print(dp)
    print_dp_matrix(a, b, dp)

    dp = fill_matrix(a,  b, score_matrix, gap_score)
    print(dp)
    print_dp_matrix(a, b, dp)

    aln = trace_back(a, b, dp, score_matrix, gap_score)
    print(aln)
    for s in aln:
        print(s)
